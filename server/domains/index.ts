...
const JSON_HYGIENE = `\n\n[출력 형식] 유효한 JSON 하나만 출력한다. hiddenPlan은 공백 포함 900자 안에서 압축해 적는다(항목은 한 줄씩, 예시 대사는 짧게). 길어지면 뒷부분이 잘려 전체가 버려진다. 문자열 값 안에서 무언가를 인용할 때는 쌍따옴표(")를 쓰지 말고 홑따옴표(')나 「」를 쓴다. 줄바꿈은 \\n 으로. 마크다운 코드 펜스는 붙이지 않는다.`
