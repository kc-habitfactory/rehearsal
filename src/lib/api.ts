...
export interface Me {
  ...
  recent: { id: number; domain?: string; title: string; score: number | null; eye_contact: number; duration_ms: number; report_status?: 'pending' | 'done' | 'failed'; created_at: string }[]
}
